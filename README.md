...
2. **Проверка переменной a на отрицательность:**  
   Первым шагом программа сравнивает a и 0. В случае положительного результата на проверку (a<0), выполняется проверка (b<0): если выражение ложно, на экран выводится x∈[0,b), если выражение верно - осуществляется сравнение (a<b), если (a<b) верно, на экран выводится x∈(а,0], если ложно - x∈(b,0].
